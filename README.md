...
<head>
  ...
  <title>Mi Amor — A Surprise for You</title>
...
<body>
  <div class="stage" id="stage">
    ...
    <div class="center-card" id="intro">
      ...
      <p class="subtitle">Tap the button, my love — a little surprise awaits you ✨</p>
    </div>
    ...
    <div class="love-scene" id="loveScene" role="main" aria-hidden="true">
      <div class="top-bar">
        ...
        <div class="controls" aria-hidden="false">
          ...
          <button id="skipBtn" class="circle-btn" title="Skip typing">⏭ <span>Skip</span></button>
          <button id="backBtn" class="ghost" title="Go back">← Back</button>
        </div>
      </div>
      ...
      <div class="content" role="region">
        ...
        <aside class="side" aria-label="Photos and actions">
          ...
          <div class="upload-row">
            <label for="fileInput" class="circle-btn" style="cursor:pointer">📷 Add photos</label>
            <input id="fileInput" class="file-input" type="file" accept="image/*" multiple>
            <button id="confettiBtn" class="ghost" title="Send confetti">🎉 Confetti</button>
          </div>
        </aside>
      </div>
    </div>
...
Our future, for me, is full of little moments: your laughter in the kitchen, your perfume on my shirts, your lipstick on my lips because I kissed you too much before we left the house. It’s you stealing my hoodies, me stealing kisses, and both of us stealing a little more time in bed every morning because getting up means stopping what we’re doing under the blanket.
...
One day, when we look back, I want us to say, “We really did it. We built this crazy, beautiful, funny, wild, romantic life together.” A life full of inside jokes, soft touches, whispered “I love yous” in the dark, and nights where the only thing louder than our laughter is our hearts beating way too fast when we get a little too close.

You are my favorite person now, and you’re my favorite future too. I can’t wait for all our cute moments, our stupid fights, our deep talks, our passionate nights, and all the times I get to pull you closer, kiss your neck, and remind you that you’re mine and I’m completely, hopelessly, happily yours.`;
